...
alias ll='eza -al'
alias jq='jaq'
alias upd='doas nixos-rebuild switch --upgrade && notify-send --urgency=low "Update completed" && pw-play --volume=0.2 "/run/current-system/sw/share/sounds/freedesktop/stereo/complete.oga" &!'
...
alias pur='paru -Rns'
alias arm='paru -Rsc'
alias pacl='paru -Scc && pw-play --volume=0.2 "/run/current-system/sw/share/sounds/freedesktop/stereo/complete.oga" &!'
...
alias pls="doas !!"
alias overwrite="paru -Syu --overwrite '*' && pw-play --volume=0.2 '/run/current-system/sw/share/sounds/freedesktop/stereo/complete.oga' &!"
alias ..='cd ..'
alias sudo=doas
