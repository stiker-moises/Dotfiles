...
alias setupeverything="touch ~/.hushlogin ; rm -rf /tmp/dotfiles ; cd /tmp/ && git clone https://gitlab.com/that1communist/dotfiles.git && cd ./dotfiles && rm -rf ./etc/nixos/configuration.nix && doas chown -R $USER:$USER ./.* && sudo cp -r ./etc / && chmod -R 750 ./.* && sd -f i 'username' $USER ./.config/mpv/scripts/autosub.lua ; sd -f i 'username' $USER ./.config/pcmanfm-qt/default/settings.conf ; sd -f i 'username' $USER ./.config/gtk-3.0/bookmarks ; sd -f i 'username' $USER ./.config/pcmanfm-qt/default/settings.conf ; sd -f i 'username' $USER ./.config/gtk-4.0/gtk.css ; touch -a ./.config/hypr/$(cat /etc/hostname).conf ; chmod +x ./.config/tofi/scripts/*.sh ; rm -rf ./.git ; cp -r ./.* ~/ ; cd ~ ; handlr set application/x-extension-htm firefox.desktop ; handlr set application/x-extension-html firefox.desktop ; handlr set application/x-extension-shtml firefox.desktop ; handlr set application/x-extension-xht firefox.desktop ; handlr set application/x-extension-xhtml firefox.desktop ; handlr set application/xhtml+xml firefox.desktop ; handlr set 'image/*' org.gnome.Loupe.desktop ; handlr set image/png org.gnome.Loupe.desktop ; handlr set image/jpeg org.gnome.Loupe.desktop ; handlr set image/gif mpv.desktop ; handlr set 'video/*' mpv.desktop ; handlr set x-scheme-handler/about firefox.desktop ; handlr set x-scheme-handler/chrome firefox.desktop ; handlr set x-scheme-handler/feed firefox.desktop ; handlr set x-scheme-handler/file pcmanfm-qt.desktop ; handlr set x-scheme-handler/ftp firefox.desktop ; handlr set x-scheme-handler/http firefox.desktop ; handlr set x-scheme-handler/https firefox.desktop ; handlr set inode/directory pcmanfm-qt.desktop ; handlr set x-scheme-handler/steam steam.desktop ; xdg-user-dirs-update ; mkdir -p ~/Pictures/.clipboard/ & mkdir -p ~/.local/share/zsh/ & mkdir ~/Torrents ; dconf write /com/github/wwmm/easyeffects/streaminputs/plugins \"['rnnoise#0', 'speex#0', 'echo_canceller', 'compressor']\" ; dconf write /com/github/wwmm/easyeffects/streaminputs/speex/0/enable-denoise false ; dconf write /com/github/wwmm/easyeffects/streaminputs/speex/0/enable-dereverb true"
...
alias updatedots="cd /tmp/ ; rm -rf ./dotfiles ; git clone https://gitlab.com/that1communist/dotfiles.git && cd dotfiles && doas chown -R $USER:$USER ./.* && doas chmod -R 750 ./.* && rm -rf ./.config/fontconfig & rm -rf ./.config/gtk-3.0 & rm -rf ./.config/gtk-4.0 & rm -rf ./.config/handlr & rm -rf ./.config/kanshi & rm -rf ./.git & rm -rf ./.config/wallpaper & rm -rf ./.config/qt5ct & rm -rf ./.config/qt6ct & rm -rf ./.config/Kvantum & rm -rf ./.config/nvim/init.vim & rm -rf ./.config/nvim/doasinit.vim & rm -rf ./.config/mimeapps.list & rm -rf ./.config/QTalarm/ & rm -rf ./.config/Syncplay & rm -rf ./.config/kdeglobals & rm -rf ./.config/zim/ & rm -rf ./.config/pcmanfm-qt/ & rm -rf ./.config/pcmanfm/ & rm -rf ./.config/galculator & rm -rf ./.config/mpv/ & rm -rf ./.config/gammastep & rm -rf ./.config/firefox & rm -rf ./.config/hypr/modules/theme.conf & rm -rf ./etc/nixos/configuration.nix && cp -r ./.* ~/ && doas cp -r ./etc / ; cd ~ ; zsh ; pw-play --volume=0.2 '/run/current-system/sw/share/sounds/freedesktop/stereo/complete.oga'"
